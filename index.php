...
<title>コスプレランキング｜レビュー評価の高いFANZA人気作品まとめ</title>
<meta name="description" content="FANZAのコスプレジャンルをレビュー評価・件数順に自動集計。実際の評価データをもとにしたランキングで作品を探せます。18歳未満閲覧禁止。">
...
<?php endif; ?>
<style>
:root { --ink:#eef0f5; --bg:#12141c; --panel:#1e2130; --accent:#5a7fe0; --accent2:#e0a85a; --line:#2f3448; --muted:#96a0b8; }
...
<h1>年齢確認</h1>
<p>このサイトはコスプレジャンル(FANZAアフィリエイト)のレビューランキング情報を扱います。18歳未満の方はご利用いただけません。</p>
...
<header>
<a href="#top" class="logo">コスプレ<span>ランキング</span></a>
...
<h1 class="main">レビュー評価の高い順で、<br><em>コスプレ</em>作品を探す。</h1>
<p class="lead">FANZA公式アフィリエイトAPIから取得した実際のレビュー評価・件数をもとに、コスプレジャンルをランキング形式で紹介しています(3件以上のレビューがある作品のみ掲載)。</p>
